...
<template>
  ...
  <section class="min-h-screen bg-[#F9F3EB] py-12 px-6">
    <div class="max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-8">
      <h1 class="text-3xl font-extrabold text-[#447C9D] mb-4">
      ...
      <div class="bg-gray-50 p-4 rounded-lg mb-4">
        <div class="flex items-center justify-between mb-4">
          <button
            @click="prevWeek"
            class="text-[#447C9D] font-medium hover:underline"
          >
            &larr; Prev Week
          </button>
        ...
        <!-- Week View -->
        <div
          class="grid grid-cols-7 gap-2 text-center text-sm text-gray-600 font-semibold mb-2"
        >
      ...
      <div class="text-right mt-6">
        <NuxtLink
          ...
          class="text-sm text-[#447C9D] hover:underline font-medium"
          >&larr; Back to Activities</NuxtLink
        >
      </div>
    </div>
  </section>
