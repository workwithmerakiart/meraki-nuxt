    ...
    sections: [
      {
        ...
        modalContent: {
          ...
          imageSrc: "/images/workshops/2.jpg",
      ...
      },
      {
        ...
        modalContent: {
          ...
          vatValue: 5,
          registerText: "Book Now",
          imageSrc: "/images/workshops/3.png",
      ...
      {
        badge: "WORKSHOPS",
        image: "/images/workshops/3d-botanical-canvas.jpeg",
        title: "3D Botanical Canvas",
        price: "150 AED",
        vat: true,
        vatValue: 5,
        dateTs: Date.parse('2026-08-02T00:00:00Z'),
        sections: [
          {
            icon: CalendarDaysIcon,
            text: "Sunday, 2 August 2026",
          },
          {
            icon: ClockIcon,
            text: "3:00 PM – 5:00 PM",
        ...
        modalContent: {
          ...
          vatValue: 5,
          registerText: "Book Now",
          imageSrc: "/images/workshops/3d-botanical-canvas.jpeg",
          imageCaption: "3D Botanical Canvas at Meraki Art Studio",
          content: "<p>Sculpt and paint your own dimensional botanical artwork in a relaxing, hands-on guided session.</p>",
        },
      },
      {
        badge: "WORKSHOPS",
        image: "/images/workshops/hair-brush.jpeg",
        title: "Hair Brush Decorating",
        price: "95 AED",
        vat: true,
        vatValue: 5,
        dateTs: Date.parse('2026-08-06T00:00:00Z'),
        sections: [
          {
            icon: CalendarDaysIcon,
            text: "Thursday, 6 August 2026",
          },
          {
            icon: ClockIcon,
        ...
        modalContent: {
          ...
          vatValue: 5,
          registerText: "Book Now",
          imageSrc: "/images/workshops/hair-brush.jpeg",
          imageCaption: "Hair Brush Decorating at Meraki Art Studio",
          content: "<p>Personalise and decorate your very own hair brush in this fun, creative session.</p>",
        },
      },
      {
        badge: "WORKSHOPS",
        image: "/images/workshops/art-of-mahjong.jpeg",
        title: "Art of Mahjong",
        price: "75 AED",
        vat: true,
        vatValue: 5,
        dateTs: Date.parse('2026-08-07T00:00:00Z'),
        sections: [
          {
            icon: CalendarDaysIcon,
            text: "Friday, 7 August 2026",
          },
          {
            icon: ClockIcon,
        ...
        modalContent: {
          ...
          vatValue: 5,
          registerText: "Book Now",
          imageSrc: "/images/workshops/art-of-mahjong.jpeg",
          imageCaption: "Art of Mahjong at Meraki Art Studio",
          content: "<p>Learn the basics of Mahjong while enjoying a fun creative evening.</p>",
        },
      },
      {
        badge: "WORKSHOPS",
        image: "/images/workshops/shell-painting.jpeg",
        title: "Shell Painting",
        price: "125 AED",
        vat: true,
        vatValue: 5,
        dateTs: Date.parse('2026-08-08T00:00:00Z'),
        sections: [
          {
            icon: CalendarDaysIcon,
            text: "Saturday, 8 August 2026",
          },
          {
            icon: ClockIcon,
            text: "11:00 AM – 1:00 PM",
        ...
        modalContent: {
          ...
          vatValue: 5,
          registerText: "Book Now",
          imageSrc: "/images/workshops/shell-painting.jpeg",
          imageCaption: "Shell Painting at Meraki Art Studio",
          content: "<p>Paint and embellish natural seashells into charming keepsakes to take home.</p>",
        },
      },
      {
        badge: "WORKSHOPS",
        image: "/images/workshops/tumbler-painting.jpeg",
        title: "Glass Tumbler Painting",
        price: "125 AED",
        vat: true,
        vatValue: 5,
        dateTs: Date.parse('2026-08-15T00:00:00Z'),
        sections: [
          {
            icon: CalendarDaysIcon,
            text: "Saturday, 15 August 2026",
          },
          {
            icon: ClockIcon,
            text: "11:00 AM – 1:00 PM",
        ...
        modalContent: {
          ...
          vatValue: 5,
          registerText: "Book Now",
          imageSrc: "/images/workshops/tumbler-painting.jpeg",
          imageCaption: "Glass Tumbler Painting at Meraki Art Studio",
          content: "<p>Design and hand-paint your own glass tumbler in this playful, beginner-friendly workshop.</p>",
        },
      },
      {
        badge: "WORKSHOPS",
        image: "/images/workshops/embellished-canvas.jpeg",
        title: "Embellished Canvas Art",
        price: "150 AED",
        vat: true,
        vatValue: 5,
        dateTs: Date.parse('2026-08-22T00:00:00Z'),
        sections: [
          {
            icon: CalendarDaysIcon,
            text: "Saturday, 22 August 2026",
          },
          {
            icon: ClockIcon,
            text: "4:00 PM – 6:00 PM",
        ...
        modalContent: {
          ...
          vatValue: 5,
          registerText: "Book Now",
          imageSrc: "/images/workshops/embellished-canvas.jpeg",
          imageCaption: "Embellished Canvas Art at Meraki Art Studio",
          content: "<p>Create a richly textured, embellished canvas using mixed media and guided techniques.</p>",
        },
      },
      {
        badge: "WORKSHOPS",
        image: "/images/workshops/lampshade-painting.jpeg",
        title: "Lampshade Painting",
        price: "150 AED",
        vat: true,
        vatValue: 5,
        dateTs: Date.parse('2026-08-28T00:00:00Z'),
        sections: [
          {
            icon: CalendarDaysIcon,
            text: "Friday, 28 August 2026",
          },
          {
            icon: ClockIcon,
            text: "4:00 PM – 6:00 PM",
        ...
        modalContent: {
          ...
          vatValue: 5,
          registerText: "Book Now",
          imageSrc: "/images/workshops/lampshade-painting.jpeg",
          imageCaption: "Lampshade Painting at Meraki Art Studio",
          content: "<p>Paint your own lampshade and bring warm, handcrafted light into your space.</p>",
        },
      },
      {
        badge: "WORKSHOPS",
        image: "/images/workshops/kinusaiga.jpeg",
        title: "Kinusaiga Japanese Art",
        price: "150 AED",
        vat: true,
        vatValue: 5,
        dateTs: Date.parse('2026-08-29T00:00:00Z'),
        sections: [
          {
            icon: CalendarDaysIcon,
        ...
        modalContent: {
          ...
          vatValue: 5,
          registerText: "Book Now",
          imageSrc: "/images/workshops/kinusaiga.jpeg",
          imageCaption: "Kinusaiga Japanese Art at Meraki Art Studio",
          content: "<p>Discover Kinusaiga, the Japanese art of patchwork without needles, to craft a beautiful fabric artwork.</p>",
        },
      },
      {
        badge: "WORKSHOPS",
        image: "/images/workshops/sequin-embroidery.jpeg",
        title: "Sequin Embroidery on a T-shirt",
        price: "150 AED",
        vat: true,
        vatValue: 5,
        dateTs: Date.parse('2026-08-30T00:00:00Z'),
        sections: [
          {
            icon: CalendarDaysIcon,
            text: "Sunday, 30 August 2026",
          },
          {
            icon: ClockIcon,
            text: "3:00 PM – 5:00 PM",
        ...
        modalContent: {
          ...
          vatValue: 5,
          registerText: "Book Now",
          imageSrc: "/images/workshops/sequin-embroidery.jpeg",
          imageCaption: "Sequin Embroidery on a T-shirt at Meraki Art Studio",
          content: "<p>Embellish your very own T-shirt (included) with sparkling sequin embroidery in this hands-on session.</p>",
        },
      },
    ],
  },
