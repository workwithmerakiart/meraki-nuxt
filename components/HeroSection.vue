        ...
        <Swiper :modules="[Autoplay, Pagination, Navigation]" :autoplay="{ delay: 5000, disableOnInteraction: false }"
            ...
            <SwiperSlide v-for="(slide, index) in slides" :key="index">
                <div class="relative w-full h-full flex items-center justify-center overflow-hidden">
                    ...
                    <!-- Content -->
                    <div class="relative z-10 text-center px-6 max-w-2xl animate-fadein-slow">
                        ...
                        <p v-if="slide.tagline" class="text-sm md:text-base text-orange-200 mb-2 animate-slidein">
                            {{ slide.tagline }}
                        </p>

                        <h1 class="text-white text-3xl md:text-5xl font-serif uppercase mb-4">{{ slide.title }}</h1>
                        <p class="text-gray-200 text-sm md:text-base mb-6">{{ slide.description }}</p>
...
const slides = [
    {
        ...
        video: 'https://stream.mux.com/SDte3KxHZW00kXTI2bjFQvamHDl00An1c1SMzEsGLOXZM/high.mp4'
    },
    {
        title: 'Workshops',
        tagline: 'Deep Dives',
    ...
    },
    {
        ...
        video: 'https://stream.mux.com/At01p00A01Zf6jXjio6HapAkDvnzExSpdGh3gkJ7C2OiPU/high.mp4'
    },
    {
        title: 'Activities',
