...
<template>
  <nav
    :class="['fixed top-0 left-0 w-full z-50 font-light', isScrolled ? 'bg-white text-black' : 'bg-transparent text-white']">
    <div class="flex items-center justify-between w-full px-4 sm:px-6 lg:px-8 py-4">
      ...
      <button @click="toggleMenu" class="relative w-8 h-6 flex flex-col justify-between items-end pr-2 sm:pr-4 group"
        ...
        <span
          class="h-1 bg-current group-hover:bg-orange-500 transition-all duration-300 ease-in-out rounded-sm w-6 group-hover:w-4"></span>
        <span
          class="h-1 bg-current group-hover:bg-orange-500 transition-all duration-300 ease-in-out rounded-sm w-full group-hover:w-full"></span>
        <span
          class="h-1 bg-current group-hover:bg-orange-500 transition-all duration-300 ease-in-out rounded-sm w-4 group-hover:w-6"></span>
      </button>
    </div>
